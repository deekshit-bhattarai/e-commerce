...
class CartManagementViewSet(viewsets.ViewSet):
    ...
    def list(self, request) -> Response:
        ...
        cart: Cart = CartService.get_or_create_cart(request)
    ...
    def add_item(self, request) -> Response:
        ...
        try:
            cart_item: CartItem = CartService.add_to_cart(
                request, product_variant_id, quantity
            )
            cart: Cart = CartService.get_or_create_cart(request)
    ...
    def remove_item(self, request) -> Response:
        ...
        request_item_quantity: int = int(request.data.get("quantity"))
        ...
        cart: Cart = CartService.get_or_create_cart(request)
        cart_item: CartItem = get_object_or_404(
